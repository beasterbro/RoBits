...
namespace Tests
{
    ...
    public class InventoryTest
    {
        ...
        private static BotInfo bot0 = new BotInfo(0,"bot0",0,allParts,body, new List<BehaviorInfo>());
        private static BotInfo bot1 = new BotInfo(1,"bot1",1,allParts,body, new List<BehaviorInfo>());
        private static BotInfo bot2 = new BotInfo(2,"bot2",2,allParts,body,new List<BehaviorInfo>());
